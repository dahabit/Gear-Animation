...
gear.xScale = (.5 * display.stageWidth) / gear.stageWidth
gear.yScale = gear.xScale

gear2.xScale = gear.xScale
gear2.yScale = gear.xScale

local centerX = display.stageWidth / 2
local centerY = display.stageHeight / 2

background.xScale = display.stageWidth / background.stageWidth
background.yScale = display.stageHeight / background.stageHeight
